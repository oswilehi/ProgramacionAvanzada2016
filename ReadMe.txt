========================================================================
    APLICACIÓN DE CONSOLA: PointersExercises_September5th Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación PointersExercises_September5th.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación PointersExercises_September5th.


PointersExercises_September5th.vcxproj
...
PointersExercises_September5th.vcxproj.filters
...
PointersExercises_September5th.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado PointersExercises_September5th.pch y un archivo de tipos precompilados llamado StdAfx.obj.
